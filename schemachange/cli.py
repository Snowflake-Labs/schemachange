...
_err_no_auth_mthd = (
    "Unable to find connection credentials for private key,  "
...
class SnowflakeSchemachangeSession:
    ...
    def authenticate(self):
        ...
        # If no password, try private key authentication
            ...
            with open(os.environ["SNOWFLAKE_PRIVATE_KEY_PATH"], "rb") as key:
                p_key = serialization.load_pem_private_key(
                    key.read(), password=private_key_password, backend=default_backend()
                )
        ...
        elif os.getenv("SNOWFLAKE_AUTHENTICATOR") == "oauth" and os.getenv(
        ...
        elif os.getenv("SNOWFLAKE_AUTHENTICATOR") == "externalbrowser" and os.getenv(
            "SNOWFLAKE_AUTHENTICATOR"
        ):
        ...
        elif os.getenv("SNOWFLAKE_AUTHENTICATOR").lower()[
            :8
        ] == "https://" and os.getenv("SNOWFLAKE_AUTHENTICATOR"):
