  ...
  """
    ...
    def authenticate(self):
        ...
        if snowflake_password:
            ...
            if os.getenv("SNOWFLAKE_AUTHENTICATOR").lower()[:8] == 'https://' and os.getenv("SNOWFLAKE_AUTHENTICATOR"):
              ...
              # default snowflake authenticator
        ...
        # If no password and only okta authenticator
    ...
    for (directory_path, directory_names, file_names) in os.walk(root_directory):
        for file_name in file_names:
            ...
            if script_name in all_files:
                raise ValueError(
                    _err_dup_scripts.format(first_path=all_files[script_name]['script_full_path'], **script))
...
def main(argv=sys.argv):
    ...
    parser_deploy.add_argument('--query-tag', type=str,
                               ...
                               required=False)
    parser_deploy.add_argument('--oauth-config', type=json.loads,
    ...
    if args.subcommand == 'render':
        renderoveride = {"snowflake_account": None, "snowflake_user": None, "snowflake_role": None, \
                         "snowflake_warehouse": None, "snowflake_database": None, "change_history_table": None, \
                         "create_change_history_table": None, "autocommit": None, "dry_run": None, "query_tag": None,
                         "oauth_config": None}
