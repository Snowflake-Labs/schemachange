...
if __name__ == '__main__':
  parser = argparse.ArgumentParser("Apply schema changes to a Snowflake data warehouse")
  parser.add_argument('-e', '--environment-name',type=str,help='The name of the environment (e.g. dev,test,prod)',required=True)
  parser.add_argument('-a', '--snowflake-account',type=str,help='The name of the environment (e.g. dev,test,prod)',required=True)
  parser.add_argument('-u', '--snowflake-user',type=str,help='The name of the environment (e.g. dev,test,prod)',required=True)
  parser.add_argument('-r', '--snowflake-role',type=str,help='The name of the environment (e.g. dev,test,prod)',required=True)
  parser.add_argument('-w', '--snowflake-warehouse',type=str,help='The name of the environment (e.g. dev,test,prod)',required=True)
  parser.add_argument('--snowflake-region',type=str,help='The name of the environment (e.g. dev,test,prod)',required=True)
  parser.add_argument('--repo-revision',type=str,help='The name of the environment (e.g. dev,test,prod)',required=True)
  parser.add_argument('-f','--root-folder', default=".",type=str,help='The name of the environment (e.g. dev,test,prod)')
  parser.add_argument('-n','--database-naming-convention', default="{0}_{1}",type=str,help='The name of the environment (e.g. dev,test,prod)')
