...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["schemachange", "deploy", "--silent"], {**DEFAULT_CONFIG, "silent": True}),
        (["schemachange", "deploy", "--pretty"], {**DEFAULT_CONFIG, "pretty": True}),
        (
            ["schemachange", "deploy", "--format-sql"],
            {**DEFAULT_CONFIG, "format_sql": True},
        ),
        (
            ["schemachange", "deploy", "--log-format", "basic"],
            {**DEFAULT_CONFIG, "log_format": "basic"},
        ),
        (
            ["schemachange", "deploy", "--script-deps"],
            {**DEFAULT_CONFIG, "script_deps": True},
        ),
        (
